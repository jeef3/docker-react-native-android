...
#       --force \
#       --all \
#       --filter platform-tools,android-25,build-tools-25.0.1,extra-android-support,extra-android-m2repository,sys-img-x86_64-android-25,extra-google-m2repository
# RUN yes | sdkmanager --licenses
